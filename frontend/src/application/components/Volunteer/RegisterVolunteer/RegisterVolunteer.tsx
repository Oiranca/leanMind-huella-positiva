...
import { volunteerRepository } from '../../../repository/Volunteer/volunteer.repository';
import '../../../../infrastructure/view/components/organisms/Forms/styles.scss';
import { CheckInterface, DataInterface } from './types';
import { LinkText } from '../../../../infrastructure/view/components/atoms/LinkText/LinkText';
  ...
  return (
    <form className="ContainerForm" method="POST" onSubmit={handleSubmit}>
      ...
      <div>
        ...
        <p>
          <input type="checkbox" required /> Estoy de acuerdo con la{' '}
          <LinkText to="privacy-policy" text="Política de Privacidad" /> del sitio.
        </p>
        <p>
          {/* Debe de hacer un POST a /api/v1/volunteers/profile/newsletter setteandoa  true */}
          <input type="checkbox" required /> Para poder ayudar es imprescindible conocer
          las convocatorias del voluntarioado. Quiero suscribirme al newsletter de
          huellapositiva.com
        </p>
      </div>
    </form>
...
RegisterVolunteer.displayName = 'RegisterVolunteer';
