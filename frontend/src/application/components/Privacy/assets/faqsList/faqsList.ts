...
export const faqsList: FaqsList[] = [
  {
    title:
  ...
  {
    title: '¿QUÉ DATOS DEL USUARIO TRATARÁ SOY MAMUT?',
    paragraph: 'Soy Mamut tratará las siguientes categorías de datos:',
    list: [
  ...
  {
    title: '¿CON QUÉ DESTINATARIOS SE COMPARTIRÁN LOS DATOS DEL USUARIO?',
    paragraph: 'Los datos del usuario podrán ser comunicados a:',
    list: [
